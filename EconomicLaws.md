...
- 上市公司增发股票：非公开/公开；公开增发股票分配股(向原股东配售)/增发(向不特定对象公开募集)
  1. 条件：
    ...
    + 增发的附加条件(+3)：向不特定对象公开募集
      1. 最近3个会计年度加权平均净资产收益率平均不低于6%(ROE≥6%)，计算时净利润取孰低者
    ...
    + 非公开发行股票的条件
      ...
      2. 法定障碍(x6+1)：
        ...
        - 现任董&高3年内受到证监会行政处罚 or 1年内受到证交所公开谴责
...
- 要约收购程序：自愿/强制；预定收购股份比例不得低于已发行股份5%
  ...
  7. 要约期满：
    ...
    + 15日内提交书面报告&公告
- 强制要约制度：
  1. 投资者取得上市公司已发行股份=30%时，继续进行收购的，应发出全面要约(即强制全面要约)：
    + 通过证交所交易的（可以在=30%上暂停）：可以买到=30%，接下来就全面要约
    + 通过协议转让的（可能无法恰好停在30%）：有>30%的部分，履行协议前必须发出全面要约
    + 以上2种满足一定条件均可向证监会申请豁免/简易申请/免于申请直接过户
    + 不予豁免的，通知之日起30日内减持至≤30%以下，也可避免强制全面要约义务
  2. **豁免事项**(x3类, 2+2+7)：
    + 可提出免于要约申请的情形(x2+1)：受理后20个工作日内答复决定；无实质变化+做好事
...
- **内幕交易行为**：
  ...
  5. 短线交易：6个月
    ...
    + 举例???：02/01买入5w股，02/10买入10w股，08/02全部卖出；02/10起算6m，10w股
- 操纵市场行为：*了解为主*
  1. 利用资金/持股/信息优势连续买卖
  2. 自己/串通者之间交易(虚假交易)
