...
- 可变更可撤销合同的撤销权是形成权，知道或应当知道后 **1年** 的除斥期间经过后权利本体消灭；人民法院不会主动释明撤销权的存在。
...
- **抵押权**：
  ...
  13. 实现抵押权：
    + 费用 - 利息 - 主债权
    + 顺位问题：
      1. 是否登记（仅登记对抗，登记生效的不登记就回家吧），都没登记 **按比例**
      2. 登记时间，一样的话按比例
...
- 免责条款：对 造成对方人身伤害、故意or重大过失造成对方财产损失的 免责条款无效
...
- 担保合同无效：
  ...
  3. 承担缔约过失责任：债权人A，债务人B，担保人C
    + 主合同有效：
      1. A无过错，BC连带
      2. AC有过错，C的责任不超过B不还的 **1/2**
    + 主合同无效使得担保合同无效：
      1. C无过错，C不承担民事责任
      2. C有过错，C的责任不超过B不还的 **1/3**
- **保证**：即人保
  ...
  2. 人数不限，不得作为保证人的有：
    + 主债务人
    + 国家机关、公益目的组织、法人的职能部门和分支机构（法人授权除外）
  3. 保证方式：
  ...
  4. 保证范围参照抵押
  5. 主合同各种变更：未经保证人书面同意，改变/加重的部分不承担保证责任
...
- 债权转让：
  1. 只需通知债务人
  2. 根据合同性质（特定身份）、约定、法律规定有不得转让情形
  3. 从权利（抵押权等）一并受让
- 债务承担：
  1. 需要取得债权人同意
  2. 债务承担协议在债权人同意时生效
- 债权债务概括移转：一般因为法人合并分立。除另有约定外，分立之后的主体债权债务 **连带**
...
- 解除：合意/法定
  ...
  2. 可以法定解除的情形：
    ...
    + 对方有违约行为致使不能实现合同目的（此条重点在目的，不用主要或催告）
    + 一些法律规定事项：
      1. 不安抗辩权相关
      2. 定作人可以随时解除承揽合同
      3. 托运人可以单方解除货运合同
...
- 买卖合同：
  ...
  3. 标的物的风险负担（非双方原因）：
    ...
    + 有运输环节：
      ...
      2. 出卖人依约代办托运（相当于是以买受人的名义托运），交给承运人后风险转移
  4. 标的物检验：
    + 不通知视为合格
    + 合理期限/收到之日起2年内（不变期间）
    + 有质量保证期的优先适用质量保证期
...
- **融资租赁合同**：书面合同，融资为目的，有点视为承租人所有的意思（只是视为，所有权在出租人）
  1. 毁损灭失风险、维修、造成他人损害的责任，由承租人承担
  2. 出卖人履行不适当，承租人行使索赔权 **不影响** 其支付租金的义务
  3. 承租人破产的，租赁物 **不属于** 破产财产
  4. 若承租人无权处分，第三人可善意取得
  5. 出租人可要求解除合同的情形：
    + 未经同意无权处分
    + 不付租金达约定情形
    + 无约定的，欠付两期以上or总额15%以上
...
- **建设工程合同**：特别的承揽合同
  ...
  4. 分包：勘察、设计、施工，每块不得肢解后发包
    ...
    + 禁止分包人再分包
  5. 承包人垫资：
    + 未约定是垫资，视为工程欠款（工程欠款利息从约定，无约定按pboc同期同类贷款利率）
    + 约定了垫资：
      1. 未约定利息则没有利息
...
- 技术合同：
  ...
  3. 技术成果的权利归属：不侵害（减少）对方（委托受托人/合作者）的权利即可
    + 委托开发的，专利权属于开发人（交付前不能转让），委托人有优先受让权
    + 合作开发的：约定优先，推定：
      1. 开发人共有，优先受让权
